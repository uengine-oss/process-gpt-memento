...
async def save_to_storage(
    ...
    try:
        ...
        if room_id and not private:
            ...
            # codex 의 _MAX_FILE_BYTES 와 같은 값이어야 한다. 여기가 좁으면 에이전트가 만든
            # 산출물이 자기 게이트를 통과하고도 413 으로 죽는다.
            chat_max_file_size = 50 * 1024 * 1024
            ...
            if len(file_content) > chat_max_file_size:
                raise HTTPException(status_code=413, detail="파일은 50MB 이하만 업로드할 수 있습니다.")
